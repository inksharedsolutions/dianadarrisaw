            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Diana Harvey Darrisaw loves to hear from readers. You can reach her via email. 
                    ...
                    <nav className="social-media-nav">
                        <ul> 
                            ...
                            <li>
                                <a href="https://www.facebook.com/Diana-Harvey-Darrisaw-101463671683348/"
                                target="_blank"
                                rel="noreferrer">
                                    <FontAwesomeIcon   
                            ...
                            <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/55030272-diabetics-happy-eating-healthy"
                                        rel="noreferrer"
                                    >
